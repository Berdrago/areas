"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_firebase_compat_functions_dist_index_esm_js"],{
...
/* harmony import */ var _firebase_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/functions */ 6157);
...
class FunctionsService {
  ...
  httpsCallable(name, options) {
    return (0,_firebase_functions__WEBPACK_IMPORTED_MODULE_1__.httpsCallable)(this._delegate, name, options);
  }

  httpsCallableFromURL(url, options) {
    return (0,_firebase_functions__WEBPACK_IMPORTED_MODULE_1__.httpsCallableFromURL)(this._delegate, url, options);
  }
  /**
  ...
  useFunctionsEmulator(origin) {
    ...
    if (match == null) {
      throw new _firebase_util__WEBPACK_IMPORTED_MODULE_2__.FirebaseError('functions', 'No origin provided to useFunctionsEmulator()');
    }

    if (match[2] == null) {
      throw new _firebase_util__WEBPACK_IMPORTED_MODULE_2__.FirebaseError('functions', 'Port missing in origin provided to useFunctionsEmulator()');
    }

    return (0,_firebase_functions__WEBPACK_IMPORTED_MODULE_1__.connectFunctionsEmulator)(this._delegate, match[1], Number(match[2]));
  }

  useEmulator(host, port) {
    return (0,_firebase_functions__WEBPACK_IMPORTED_MODULE_1__.connectFunctionsEmulator)(this._delegate, host, port);
  }
...
function registerFunctions() {
  ...
  _firebase_app_compat__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL.registerComponent(new _firebase_component__WEBPACK_IMPORTED_MODULE_3__.Component('functions-compat', factory, "PUBLIC"
  /* PUBLIC */
...
class FunctionsError extends _firebase_util__WEBPACK_IMPORTED_MODULE_2__.FirebaseError {
  constructor(
  /**
...
function _postJSON() {
  _postJSON = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, body, headers, fetchImpl) {
...
function _callAtURL() {
  _callAtURL = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (functionsInstance, url, data, options) {
    ...
    const response = yield Promise.race([postJSON(url, body, headers, functionsInstance.fetchImpl), failAfterHandle.promise, functionsInstance.cancelAllRequests]); // Always clear the failAfter timeout
...
function registerFunctions(fetchImpl, variant) {
  ...
  (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__._registerComponent)(new _firebase_component__WEBPACK_IMPORTED_MODULE_3__.Component(FUNCTIONS_TYPE, factory, "PUBLIC"
  /* PUBLIC */
...
function getFunctions(app = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__.getApp)(), regionOrCustomDomain = DEFAULT_REGION) {
  // Dependencies
  const functionsProvider = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_1__._getProvider)((0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.getModularInstance)(app), FUNCTIONS_TYPE);
...
function connectFunctionsEmulator(functionsInstance, host, port) {
  connectFunctionsEmulator$1((0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.getModularInstance)(functionsInstance), host, port);
}
/**
 * Returns a reference to the callable HTTPS trigger with the given name.
 * @param name - The name of the trigger.
...
function httpsCallable(functionsInstance, name, options) {
  return httpsCallable$1((0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.getModularInstance)(functionsInstance), name, options);
}
/**
...
function httpsCallableFromURL(functionsInstance, url, options) {
  return httpsCallableFromURL$1((0,_firebase_util__WEBPACK_IMPORTED_MODULE_2__.getModularInstance)(functionsInstance), url, options);
}
/**
...
/***/ 6905:
/*!******************************************************************!*\
  !*** ./node_modules/firebase/compat/functions/dist/index.esm.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_functions_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/functions-compat */ 8324);


/***/ })

}]);
//# sourceMappingURL=node_modules_firebase_compat_functions_dist_index_esm_js.js.map