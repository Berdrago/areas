"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_firebase_compat_messaging_dist_index_esm_js"],{
...
function _migrateOldDatabase() {
  _migrateOldDatabase = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (senderId) {
    ...
    const db = yield (0,idb__WEBPACK_IMPORTED_MODULE_3__.openDB)(OLD_DB_NAME, OLD_DB_VERSION, {
      upgrade: function () {
        var _ref = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (db, oldVersion, newVersion, upgradeTransaction) {
          var _a;
...
function _dbGet() {
  _dbGet = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
...
function _dbSet() {
  _dbSet = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
...
function _dbRemove() {
  _dbRemove = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _requestGetToken() {
  _requestGetToken = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _requestUpdateToken() {
  _requestUpdateToken = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _requestDeleteToken() {
  _requestDeleteToken = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, token) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _getHeaders() {
  _getHeaders = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
    appConfig,
    installations
  }) {
...
function _getTokenInternal() {
  _getTokenInternal = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
...
function _deleteTokenInternal() {
  _deleteTokenInternal = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
    const tokenDetails = yield dbGet(messaging.firebaseDependencies);
...
function _updateToken() {
  _updateToken = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, tokenDetails) {
    try {
...
function _getNewToken() {
  _getNewToken = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _getPushSubscription() {
  _getPushSubscription = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (swRegistration, vapidKey) {
...
function _stageLog() {
  _stageLog = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, internalPayload) {
...
function _onSubChange() {
  _onSubChange = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
    var _a, _b;
...
function _onPush() {
  _onPush = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
...
function _onNotificationClick() {
  _onNotificationClick = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
    var _a, _b;
    ...
    if (!client) {
      client = yield self.clients.openWindow(link); // Wait three seconds for the client to initialize and set up the message handler so that it
...
function _getWindowClient() {
  _getWindowClient = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
    const clientList = yield getClientList();
...
function registerMessagingInSw() {
  (0,_firebase_app__WEBPACK_IMPORTED_MODULE_5__._registerComponent)(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__.Component('messaging-sw', SwMessagingFactory, "PUBLIC"
  /* PUBLIC */
  ));
}
/**
...
function _isSwSupported() {
  _isSwSupported = (0,C_Users_Gary_Desktop_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_messaging_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/messaging-compat */ 4802);
...
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 4692);
/* harmony import */ var _firebase_messaging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/messaging */ 4557);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 7748);
/* harmony import */ var _firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/messaging/sw */ 510);
...
function registerMessagingCompat() {
  _firebase_app_compat__WEBPACK_IMPORTED_MODULE_1__["default"].INTERNAL.registerComponent(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__.Component('messaging-compat', messagingCompatFactory, "PUBLIC"
  /* PUBLIC */
...
//# sourceMappingURL=node_modules_firebase_compat_messaging_dist_index_esm_js.js.map